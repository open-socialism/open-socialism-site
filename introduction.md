...
* There should be computer programs that automatically analyze data around decision making and check for patterns that indicate bias or corruption. These programs can also analyze banks accounts and transactions to look for suspicious activity that could indicate corruption.
