...
The Open Socialism project posits the idea that capitalism and democracy have existed for 300 years in a similar fundamental form. Meanwhile, technology, our understanding of ourselves and team and culture management techniques have greatly advanced. So many new ways of organizing are now possible. Surely, a modern rethink can be better and indeed is necessary given the current levels of wealth inequality and environmental destruction.

Open Socialism has one current idea, but there are many posibilities. The goal is produce a superior alterna
